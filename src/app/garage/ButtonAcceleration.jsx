    ...
    <div className='flex flex-col gap-2'>
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} >
        ...
        <div className="flex flex-col justify-center items-center gap-6">
          ...
          <p className='text-white text-center'>Are you sure you want to upgrade accel for 0.8417 GPoints?</p>
      ...
      <div className='flex gap-2 items-center justify-center'>
        <LuLoaderPinwheel className='text-white' /> <span className='text-white'>acceleration</span>
      </div>
      <div className='flex gap-2 items-center justify-center'>
...
export default ButtonAcceleration
